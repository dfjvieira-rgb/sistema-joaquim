...
Nos casos em que a lei exigir liquidação de valores, não se faz necessária sua apresentação pelo Examinando, pois admite-se que o escritório possui setor próprio ou contratado especificamente para tal fim. (Valor: 5,00)
...
JOSÉ FININHO, garçom, qualificação e endereço completos, vem, respeitosamente, perante Vossa Excelência, por intermédio de seu advogado adiante assinado (procuração anexa), com escritório profissional no endereço completo, onde recebe intimações ou notificações, com fulcro no art. 840, caput e § 1º, da CLT, PROPOR:
...
em face de HEART ATTACK GRILL LTDA., qualificação e endereço completos, e SINDICATO DOS EMPREGADOS ..., qualificação e
...
O reclamante foi contratado pela reclamada no mesmo dia em que Juan para exercer a mesma função, na mesma filial, com a mesma produtividade e perfeição técnica, porém, enquanto recebia R$ 2.000,00, o seu colega recebia salário fixo de R$ 2.500,00 por mês.
Nos termos do art. 461, caput e § 1º, da CLT, é devido o mesmo salário aos empregados do mesmo empregador que exerçam a mesma função, no mesmo estabelecimento comercial, com a mesma produtividade e perfeição técnica e cuja diferença de tempo de serviço para o mesmo empregador não seja superior a quatro anos e de tempo na função não seja superior a dois anos.
Diante do exposto, requer a condenação da reclamada ao pagamento das diferenças salariais, bem como de seus reflexos nas verbas contratuais e rescisórias (aviso prévio, décimo terceiro, férias acrescidas de 1/3 e FGTS - depósitos e multa de 40%).
Por fim, requer a retificação da CTPS do empregado para constar o seu real salário, no valor e R$ 2.500,00, nos termos do art. 29, § 1º, da CLT. R$
...
A reclamada descontou do salário do reclamante um dia de trabalho no mês de janeiro do ano da extinção do contrato, em razão de o reclamante ter faltado ao trabalho para comparecer em juízo como parte no processo em que litigava contra seu antigo empregador, muito embora tivesse apresentado certidão da Justiça do Trabalho confirmando suas alegações.
...
P á g i n a 11 | 551
 @aryannalinhares @professoraaryannalinhares
Com base no art. 473, VIII, da CLT e súmula 155, TST, o empregado poderá deixar de comparecer ao serviço para comparecimento como parte na Justiça do Trabalho.
Diante do exposto, requer a condenação da reclamada à devolução do dia de trabalho descontado de seu salário. R$
...
O reclamante trabalhava 8 horas diárias de segunda a sexta-feira e usufruía de apenas 30 minutos de intervalo intrajornada.
...
Diante do exposto, requer a condenação da reclamada ao pagamento do período suprimido, ou seja, de 30 minutos diários, acrescidos de 50%, à luz do art. 71, § 4º, da CLT. R$
...
Nos termos do art. 611-B, III, da CLT, é ilícita e, portanto, nula a cláusula de acordo coletivo de trabalho que implique redução do valor dos depósitos mensais do FGTS. Ressalte-se que, o art. 15 da Lei nº 8.036/90 determina que os depósitos do FGTS devem ser de 8% da remuneração paga ou devida ao trabalhador no mês anterior.
Diante do exposto, requer a declaração de nulidade da cláusula do acordo coletivo de trabalho que estabelece a redução dos depósitos do FGTS e a condenação da reclamada ao pagamento das diferenças salariais. R$
No curso do contrato, o empregador depositava apenas 4% do valor da
...
Requer a condenação da reclamada ao pagamento de honorários advocatícios, no importe de 15%, sobre o valor que resultar da liquidação, à luz do art. 791-A da CLT. R$
...
a) a condenação da reclamada ao pagamento das diferenças salariais, bem como de seus reflexos nas verbas contratuais e rescisórias;
b) a condenação da reclamada à devolução do dia de trabalho descontado de seu salário;
c) a condenação da reclamada ao pagamento do período suprimido, ou seja, de 30 minutos diários, acrescidos de 50%, nos termos do art. 71, § 4º, da CLT;
d) a declaração de nulidade da cláusula do acordo coletivo de trabalho que institui a redução dos depósitos do FGTS e a condenação da reclamada ao pagamento das diferenças salariais;
e) a condenação da reclamada ao pagamento de honorários advocatícios, no importe de 15% sobre o valor que resultar da liquidação, à luz do art. 791-A da CLT.
...
Diante do exposto, requer:
a) a notificação da Reclamada e do Sindicato dos Empregados em..., para oferecer resposta à reclamação trabalhista, sob pena de revelia e confissão quanto à matéria de fato;
...
OAB nº`,
    ...
    'consigna': { 
        1: `6.3. EXERCÍCIO DE AÇÃO DE CONSIGNAÇÃO EM PAGAMENTO (EOAB X - ADAPTADO)
Zenga Modas Ltda... dispensa sem justa causa Joana Firmino... Joana cientificada de que deveria comparecer para receber verbas rescisórias, mas não compareceu.

AO DOUTO JUÍZO DA ... VARA DO TRABALHO DE MACEIÓ/AL.
ZENGA MODAS LTDA... vem propor: AÇÃO DE CONSIGNAÇÃO EM PAGAMENTO em face de JOANA FIRMINO...
...
III – REQUERIMENTOS FINAIS
Depósito dos valores e bens, citação para levantamento ou resposta e procedência total.`,
        'guia': `💡 POR QUE ESSA FUNDAMENTAÇÃO?\n\n1. CABIMENTO: Art. 539 CPC c/c 769 CLT. Mora do credor (empregada sumiu).\n2. MULTA 477: Tese de defesa essencial. Se o atraso não é culpa do patrão, não há multa.\n3. DEPÓSITO DE BENS: O celular e a CTPS também devem ser consignados.`
Diante do exposto, requer:
...
Floricultura Flores Belas Ltda vs Estela. Reclamação trabalhista com pedidos de penosidade, horas extras, multa 477 e devolução de plano de saúde.
...
I – PRELIMINAR
1. Incompetência da Justiça do Trabalho para crimes (Art. 337, II CPC).
2. Inépcia da inicial (Art. 330, § 1º, I CPC) quanto ao plano de saúde sem pedido.

II – PREJUDICIAL
Prescrição quinquenal (Art. 7º, XXIX CF / Art. 11 CLT).
...
III – MÉRITO
1. Penosidade: Falta de regulamentação legal (Art. 7º, XXIII CF).
2. Horas Extras: Jornada dentro dos limites de 8h diárias e 44h semanais.
3. Multa 477: Pagamento no prazo de 10 dias após o término do aviso projetado.
...
Diante do exposto, requer a improcedência do pedido da reclamante.
IV – RECONVENÇÃO
Dano Material pela vidraça quebrada (Art. 186 e 927 CC).`,
...
Rômulo Delgado Silva vs Sônia Cristina de Almeida. Penhora de imóvel único (bem de família) e aplicação de multa do CPC.
...
RESOLUÇÃO
AO DOUTO JUÍZO DA 50a VARA DO TRABALHO DE BOA VISTA, RORAIMA
EMBARGOS À EXECUÇÃO (Art. 884 CLT)

AO DOUTO JUÍZO DA 50a VARA DO TRABALHO DE BOA VISTA,
RORAIMA
Processo no xxx
RÔMULO DELGADO SILVA, já qualificado nos autos em epígrafe, em
que contende com SÔNIA CRISTINA DE ALMEIDA, também qualificada,
...
III – MÉRITO
1. Impenhorabilidade: Único imóvel, bem de família (Lei 8.009/90 e Súmula 364 STJ).
2. Multa 523 CPC: Inaplicável ao Processo do Trabalho ( CLT tem rito próprio).
3. Excesso de penhora: Bem de R$ 180k para dívida de R$ 150k.`,
...
viúvas.
Dessa forma, o bem in questão não é passível de penhora, razão pela
...
OAB n°`
    ...
    // Demais peças em branco para preenchimento futuro
    'inquerito': { 1: `Texto em branco...` },
    'ed': { 1: `Texto em branco...` },
    'replica': { 1: `Texto em branco...` },
    'ro': { 1: `Texto em branco...` },
    'rade': { 1: `Texto em branco...` },
    'ai': { 1: `Texto em branco...` },
    'rr': { 1: `Texto em branco...` },
    'emb_tst': { 1: `Texto em branco...` },
    're_stf': { 1: `Texto em branco...` },
    'epe': { 1: `Texto em branco...` },
    'ap': { 1: `Texto em branco...` },
    'emb_terc': { 1: `Texto em branco...` },
    'ms': { 1: `Texto em branco...` },
    'ar': { 1: `Texto em branco...` }
    // Peças apenas com marcadores para não perder a estrutura
    'inquerito': { 1: `(Texto do Inquérito para Apuração de Falta Grave será inserido aqui)` },
    'ed': { 1: `(Texto de Embargos de Declaração será inserido aqui)` },
    'replica': { 1: `(Texto de Réplica será inserido aqui)` },
    'ro': { 1: `(Texto de Recurso Ordinário será inserido aqui)` },
    'rade': { 1: `(Texto de Recurso Adesivo será inserido aqui)` },
    'ai': { 1: `(Texto de Agravo de Instrumento será inserido aqui)` },
    'rr': { 1: `(Texto de Recurso de Revista será inserido aqui)` },
    'emb_tst': { 1: `(Texto de Embargos ao TST será inserido aqui)` },
    're_stf': { 1: `(Texto de Recurso Extraordinário será inserido aqui)` },
    'epe': { 1: `(Texto de Exceção de Pré-Executividade será inserido aqui)` },
    'ap': { 1: `(Texto de Agravo de Petição será inserido aqui)` },
    'emb_terc': { 1: `(Texto de Embargos de Terceiro será inserido aqui)` },
